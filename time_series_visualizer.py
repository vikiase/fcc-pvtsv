...
#Tato funkce byla zavedena, aby se zabránilo varování, které se může vyskytnout při použití dat a časů ve spojení s Matplotlibem.
register_matplotlib_converters()

df = pd.read_csv('fcc-forum-pageviews.csv')
#převodu sloupce date ve DataFrame na typ datetime
